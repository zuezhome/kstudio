package com.musicplayer.aow.ui.library.activities.artistsonglist
 ...
 */
class ArtistSongsListAdapter(context: Context, song: List<Song>): RecyclerView.Adapter<ArtistSongsListAdapter.SongListViewHolder>() {
